...
class UnifiedChemicalParser:
    ...
    def parse(self, filepath: str, format_type: Optional[str] = None, **kwargs) -> Network:
        """
...
def parse_chemical_network(filepath: str, format_type: Optional[str] = None, **kwargs) -> Network:
    """
